package SVG::Rasterize::Specification::Font;
use strict;
use warnings;
...
# $Id: Font.pm 6484 2011-04-21 09:25:12Z powergnom $

=head1 NAME

C<SVG::Rasterize::Specification::Font> - specification for class Font
...
our %ATTR_VAL = ('font'      => {'alignment-baseline'           => {'optional' => 1,
                                                                    'type'     => SCALAR,
...
our %ATTR_HINTS = ('font'      => {'color'        => {'color'  => 1},
                                   'fill'         => {'color'  => 1},
                                   'stroke'       => {'color'  => 1},
