package SVG::Rasterize::Specification::Marker;
use strict;
use warnings;
...
# $Id: Marker.pm 6484 2011-04-21 09:25:12Z powergnom $

=head1 NAME

C<SVG::Rasterize::Specification::Marker> - specification for class Marker
...
our %ATTR_VAL = ('marker' => {'alignment-baseline'           => {'optional' => 1,
                                                                 'type'     => SCALAR,
...
our %ATTR_HINTS = ('marker' => {'color'        => {'color'  => 1},
                                'fill'         => {'color'  => 1},
