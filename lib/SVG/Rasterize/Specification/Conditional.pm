package SVG::Rasterize::Specification::Conditional;
use strict;
use warnings;
...
# $Id: Conditional.pm 6211 2010-06-15 04:21:13Z mullet $

=head1 NAME

C<SVG::Rasterize::Specification::Conditional> - specification for class Conditional
...
our %ATTR_VAL = ('switch' => {'alignment-baseline'           => {'optional' => 1,
                                                                 'type'     => SCALAR,
...
our %ATTR_HINTS = ('switch' => {'color'        => {'color'  => 1},
                                'fill'         => {'color'  => 1},
                                'stroke'       => {'color'  => 1},
