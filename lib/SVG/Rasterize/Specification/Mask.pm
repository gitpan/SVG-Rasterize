package SVG::Rasterize::Specification::Mask;
use strict;
use warnings;
...
# $Id: Mask.pm 6484 2011-04-21 09:25:12Z powergnom $

=head1 NAME

C<SVG::Rasterize::Specification::Mask> - specification for class Mask
...
our %ATTR_VAL = ('mask' => {'alignment-baseline'           => {'optional' => 1,
                                                               'type'     => SCALAR,
...
our %ATTR_HINTS = ('mask' => {'color'        => {'color'  => 1},
                              'fill'         => {'color'  => 1},
                              'height'       => {'length' => 1},
                              'stroke'       => {'color'  => 1},
